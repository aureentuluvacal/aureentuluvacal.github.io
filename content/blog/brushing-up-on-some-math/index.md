...
![Delta y delta x getting smaller]({{ site.image_url }}/posts/derivatives.png)

Mathematically this is represented as

$$
f\prime(x) = \lim_{h \to \infty} {f(x + h) - f(x) \over h}
$$
...
$$
\int_{2}^{5} 2x \, dx = \lbrack x^2 \rbrack _2^5 = 5^2 - 2^2 = 21
$$
...
$$
\int x^4 + 2x \, dx = {x^5 \over 5} + x^2 + K
$$
...
$$
\int_{t=0}^{t=\pi /2} f(x, y) \, dS = \int_{t=0}^{t=\pi /2} \cos^2 t + \sin^2 t \, \sqrt{\frac{dx}{dt}^2 + \frac{dy}{dt}^2} dt
$$
